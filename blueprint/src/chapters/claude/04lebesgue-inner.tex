...
任意の二つの長方体 $I_1, I_2 \supset A$ に対しては，
共通の長方体 $J \supset I_1 \cup I_2$ を取って
...
\[
m_*(A) := \sup\{m_*(A \cap I) : I \text{ は有界閉長方体}\}
\]
...
\item （補集合との関係）$A \subset I$（有界閉長方体）ならば
...
\begin{theorem}[長方体・基本集合の内測度]\label{thm:inner-elementary}
\begin{enumerate}
\item 半開長方体 $Q$ に対して $m_*(Q) = |Q|$．
\item 基本集合 $E$ に対して $m_*(E) = m_J(E)$．
\end{enumerate}
\end{theorem}
\begin{proof}
$I \supset E$ を有界閉長方体とする．
