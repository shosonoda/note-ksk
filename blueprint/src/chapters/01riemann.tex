...
\subsection{Darbouxの上積分と下積分による定義}
...
\subsection{Riemann積分の長所と短所}

\paragraph{長所：定義が素朴であり，計算しやすい}
\begin{itemize}
    \item Riemann和 $\approx$ 単関数 $\approx$ 区分求積法
    \item 微分積分学の基本定理
\end{itemize}
