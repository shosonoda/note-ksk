...
\]
と定める．
これは $\mathcal A$ 上の前測度である．
ここから生成される外測度は，第3章で導入したLebesgue外測度と一致し，
Carathéodoryの定理により第5章のLebesgue測度が得られる．
\end{example}
...
\]
という3段階の拡張によって作られている．
Jordan測度が有限加法的な図形の体積にとどまっていたのに対し，
Lebesgue測度では可算分割に耐える形へ理論が完成される．
\end{remark}
