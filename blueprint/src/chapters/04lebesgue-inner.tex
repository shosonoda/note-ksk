...
\[
\sup\left\{ \sum_{i=1}^\infty |R_i| \;\middle|\; \bigcup_{i=1}^\infty R_i \subset A,\ R_i \text{ は互いに素な左半開区間}\right\}
\]
のように定めたくなるのは自然である．
ただし，ここでは外測度のような covering ではなく packing を考えなければならない．
実際，supremum を取る以上，区間の重なりを許すと同じ部分を何度でも数えられてしまうからである．

しかし，互いに素な区間による packing にしても，本質的には $A$ の内部しか見えない．
非退化な左半開区間 $R_i$ は非空な開集合を含むので，$R_i \subset A$ なら
\[
